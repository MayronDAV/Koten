...
namespace KTN::UI
{
	...
	KTN_API void ImageCircleMask(const Ref<Texture2D>& p_Texture, const ImVec2& p_Size, const ImVec4& p_BgColor = { 0.5, 0.5, 0.5, 1 }, bool p_Border = false, const ImVec4& p_BorderColor = { 1, 1, 1, 1 }, float p_BorderThickness = 2.0f);
	KTN_API void ImageCircleMask(const Ref<Texture2D>& p_Texture, const ImVec2& p_Size, const ImVec2& p_UV0, const ImVec2& p_UV1, const ImVec4& p_BgColor = { 0.5, 0.5, 0.5, 1 }, bool p_Border = false, const ImVec4& p_BorderColor = { 1, 1, 1, 1 }, float p_BorderThickness = 2.0f);
