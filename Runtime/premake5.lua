project "Runtime"
	...
	filter "system:windows"
		...
		postbuildcommands 
		{
			("{COPYFILE} %{wks.location}/bin/" .. outputdir .. "/Koten/Koten.dll %{wks.location}/Editor/Resources/%{prj.name}/")
		}
	...
	filter "system:linux"
		...
		postbuildcommands 
		{
			("{COPY} %{wks.location}/bin/" .. outputdir .. "/Koten/libKoten.so %{wks.location}/Editor/Resources/%{prj.name}/")
		}
